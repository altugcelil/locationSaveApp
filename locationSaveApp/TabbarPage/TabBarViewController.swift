...
class TabBarViewController: UITabBarController {
    ...
    private func setupTabBar() {
        ...
        let homePageStoryBoardd = UIStoryboard.init(name: "HomePage", bundle: nil)
        let secondVc = homePageStoryBoardd.instantiateViewController(withIdentifier: "homePageTab")
        ...
        let thirdVc = homePageStoryBoardd.instantiateViewController(withIdentifier: "homePageTab")
